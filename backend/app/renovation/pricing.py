...
def build_estimate(
    ...
    *,
    ...
    response = {
        ...
        "source_url": SOURCES[source_ids[0]].url if source_ids else "fixture://no-price-source",
        "retrieved_at": max((SOURCES[source_id].retrieved_on for source_id in source_ids), default="2026-08-31"),
        "source_period": PRICE_SNAPSHOT_VERSION,
        "transformation_version": PRICE_SNAPSHOT_VERSION,
        "rights_status": "source_recorded",
        "rights_confirmed": "no",
        "sample_size": len(items),
        "aggregation_method": "deterministic_range_rules",
        "missing_value_policy": "omit_unobserved_or_unpriced_items",
        "unit": "JPY",
        "currency": "JPY",
        "tax_basis": "approximate",
