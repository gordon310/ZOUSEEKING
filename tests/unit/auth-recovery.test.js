...
test("uses the same six-to-128 password rule as registration", () => {
  assert.equal(recovery.isPasswordValid("a".repeat(5)), false);
  assert.equal(recovery.isPasswordValid("a".repeat(6)), true);
